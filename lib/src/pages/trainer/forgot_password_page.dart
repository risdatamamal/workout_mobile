...
class TrainerForgotPasswordPage extends StatefulWidget {
  @override
  State<TrainerForgotPasswordPage> createState() => _TrainerForgotPasswordPageState();
}

class _TrainerForgotPasswordPageState extends State<TrainerForgotPasswordPage> {
